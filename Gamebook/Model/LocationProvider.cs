...
namespace Gamebook.Model
{
    public class LocationProvider : ILocationProvider
    {
        ...
        public List<Connection> Connections { get; set; } = new List<Connection>
        {
            ...
            new Connection(1, 2, "Go through Nether portal"),//z cesty do portalu
            new Connection(2, 1, "Return to Over World"),//z portalu zpet na OW
            ...
            new Connection(5, 4, "Return to Road"),//z vesnice na cestu
            ...
            new Connection(9, 10, "Return to Road in Nether"),//z fortress na cestu
            new Connection(6,10, "Return to The Nether"),//zpet do netheru ze strongholdu
            new Connection(10,6, "Go through Nether Portal to Stronghold")//nether do stronghold
        };
